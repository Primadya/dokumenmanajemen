        ...
        <main class="flex-1 p-6 bg-white">
                ...
                <div class="w-full">
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div 
                            ...
                            data-pdf="<?php echo e(asset('storage/' . $msg->document_path)); ?>"
                            data-notes="<?php echo e(e($msg->notes)); ?>"
                        >
                            <div class="flex justify-between items-center">
                                <h3 class="font-semibold"><?php echo e($msg->from_department); ?></h3>
                                <span class="text-sm text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($msg->created_at)->diffForHumans()); ?>

                                </span>
                            </div>
                            <h4 class="font-medium text-gray-900"><?php echo e($msg->title); ?></h4>
                            <p class="text-sm text-gray-600 truncate">
                                No. Dokumen: <?php echo e($msg->document_number); ?> • Revisi: <?php echo e($msg->revision); ?>
            ...
            <div id="replyUploadModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
                <div class="bg-white rounded-lg w-11/12 max-w-2xl p-6 relative">
                    ...
                    <form method="POST" action="<?php echo e(route('pertamina.upload.store')); ?>" enctype="multipart/form-data" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label class="block mb-1 font-semibold">Nomor Transmital (Otomatis)</label>
                            <input type="text" name="transmittal_number" value="<?php echo e($generatedTransmitalNumber ?? 'Auto'); ?>" class="border rounded w-full p-2 bg-gray-100" readonly>
                        </div>
                        <div>
...
<?php /**PATH C:\laragon\www\project\resources\views/pertamina/dashboard.blade.php ENDPATH**/ ?>